 ...
 */
export const unregisterPushTokenBodyTokenRegExp = new RegExp('^(ExponentPushToken|ExpoPushToken)\\[[^\\]]+\\]$');


export const UnregisterPushTokenBody = zod.object({
  "token": zod.string().regex(unregisterPushTokenBodyTokenRegExp)
})
 ...
 */
export const discoverContactsBodyPhoneHashesItemRegExp = new RegExp('^[a-f0-9]{64}$');
export const discoverContactsBodyPhoneHashesMax = 500;



export const DiscoverContactsBody = zod.object({
  "phoneHashes": zod.array(zod.string().regex(discoverContactsBodyPhoneHashesItemRegExp)).min(1).max(discoverContactsBodyPhoneHashesMax)
})

export const discoverContactsResponseMatchesItemPhoneHashRegExp = new RegExp('^[a-f0-9]{64}$');


export const DiscoverContactsResponse = zod.object({
  "matches": zod.array(zod.object({
  "phoneHash": zod.string().regex(discoverContactsResponseMatchesItemPhoneHashRegExp),
  "user": zod.object({
  "id": zod.number(),
  "phone": zod.string(),
  "hasRegisteredPhone": zod.boolean(),
...
export const UpdateUserProfileBody = zod.object({
  ...
  "phoneDiscoveryPermission": zod.enum(['contacts', 'everyone', 'nobody']).optional()
})
...
export const createMessageBodyOneContentMax = 2000;
...
export const createMessageBodyOneAttachmentDurationMin = 0;

export const createMessageBodyTwoContentMax = 2000;
...
export const createMessageBodyTwoAttachmentDurationMin = 0;
...
export const CreateMessageBody = zod.union([zod.object({
  ...
  "width": zod.number().min(1).optional(),
  "height": zod.number().min(1).optional(),
  "duration": zod.number().min(createMessageBodyOneAttachmentDurationMin).optional()
}).optional()
}),zod.object({
  "senderId": zod.number().optional(),
  ...
  "width": zod.number().min(1).optional(),
  "height": zod.number().min(1).optional(),
  "duration": zod.number().min(createMessageBodyTwoAttachmentDurationMin).optional()
})
})]).and(zod.object({
  "senderId": zod.number(),

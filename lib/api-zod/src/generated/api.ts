...
export const ListCallsResponse = zod.object({
  ...
  "callerId": zod.number(),
  "calleeId": zod.number(),
  "status": zod.enum(['ringing', 'accepted', 'declined', 'missed', 'ended']),
  "roomName": zod.string(),
  "createdAt": zod.number(),
  "acceptedAt": zod.number().nullable(),
  "declinedAt": zod.number().nullable(),
  "endedAt": zod.number().nullable(),
  "missedAt": zod.number().nullable(),
...
export const GetCallParams = zod.object({
  "callId": zod.coerce.number().int().min(1)
})
...
export const GetCallLiveKitTokenParams = zod.object({
  "callId": zod.coerce.number().int().min(1)
})

export const GetCallLiveKitTokenResponse = zod.object({
  "token": zod.string(),
  "url": zod.string(),
  "roomName": zod.string()
})
...
export const GetCurrentEventLiveKitTokenParams = zod.object({
  "roomId": zod.coerce.number().min(1)
})

export const GetCurrentEventLiveKitTokenResponse = zod.object({
  "token": zod.string(),
  "url": zod.string(),
  "roomName": zod.string(),

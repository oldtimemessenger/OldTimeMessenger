...
const styles = StyleSheet.create({
  ...
  sponsoredBadgeText: { color: '#FFFFFF', fontSize: 12, fontWeight: '600' },
  ...
  adLabelText: { color: 'rgba(255,255,255,0.82)', fontSize: 11, fontWeight: '600' },
  reserved: { color: 'rgba(255,255,255,0.76)', fontSize: 12, fontWeight: '600' },
  advertiserInfo: { paddingBottom: 12 },
  advertiserName: { color: '#FFFFFF', fontSize: 12, fontWeight: '600', textTransform: 'uppercase', letterSpacing: 0.6 },
  headline: { color: '#FFFFFF', fontSize: 24, lineHeight: 29, fontWeight: '600', marginTop: 5 },
  ...
  ctaText: { color: '#1C3550', fontSize: 14, fontWeight: '600' },
});
